...
const ItemBookModal = ({ advertiseItem, setAdvertiseItem }) => {
    // console.log()
    const { name, resale, image, seller } = advertiseItem;
    ...
    const handleBooking = event => {
        ...
        const bookinginfo = {
            bookingProductId: advertiseItem.productId,
            name,
            price: resale,
